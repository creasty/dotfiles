...
command! CleanBuffers :call vimrc#utils#clean_buffers()

" create directories if not exist
autocmd vimrc_utils BufWritePre *
 \ call vimrc#utils#auto_mkdir(expand('<afile>:p:h'))

" delete current file
command! -nargs=0 Delete call vimrc#utils#delete_or_trash(expand('%:p')) | enew!
...
command! -nargs=0 NextFile call vimrc#utils#next_file(1)
command! -nargs=0 PrevFile call vimrc#utils#next_file(-1)
